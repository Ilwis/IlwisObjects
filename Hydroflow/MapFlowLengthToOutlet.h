...
#ifndef MAPFLOWLENGTH2OUTLET_H
#define MAPFLOWLENGTH2OUTLET_H

namespace Ilwis {
	namespace Hydroflow {

		class MapFlowLength2Outlet : public OperationImplementation
		{
		public:

			MapFlowLength2Outlet();

			MapFlowLength2Outlet(quint64 metaid, const Ilwis::OperationExpression& expr);
		...
		/*	void Lengths2Stream(long iStreamID, Pixel rc, bool);
			...
			void Lengths2Outlet(long iStreamID, Pixel rc, bool fUpstreamlins);

			NEW_OPERATION(MapFlowLength2Outlet);
		};

	}
}

#endif // MAPFLOWLENGTH2OUTLET_H
